...
run(bail_data, bail_actionable_indices, bail_categorical_features, bail_experiment_dir, [0.15, 0.2, 0.3, 0.35, 0.4, 0.45], delta_max, do_train = True, thresholds_to_eval = thresholds_to_eval)
