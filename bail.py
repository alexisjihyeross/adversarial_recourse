...
bail_experiment_dir = 'new_results/0907_bail_0.5/'
...
weights = [0.0, 0.05, 0.1, 0.15, 0.2, 0.3, 0.35, 0.4, 0.45, 0.5]
# run(bail_data, bail_actionable_indices, bail_categorical_features, bail_experiment_dir, weights, delta_max, do_train = True, thresholds_to_eval = thresholds_to_eval)