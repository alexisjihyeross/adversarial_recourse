...
run(compas_data, compas_actionable_indices, compas_categorical_features, compas_experiment_dir, [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5], delta_max, do_train = True, thresholds_to_eval = thresholds_to_eval)
