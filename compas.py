...
run(compas_data, compas_actionable_indices, compas_categorical_features, compas_experiment_dir, weights, delta_max, do_train = True, thresholds_to_eval = thresholds_to_eval)
